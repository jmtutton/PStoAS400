...
//		End-if    !$PSEmpl <> '' and $PSEmpl <> ' '
	 ...
	 */
	public static Integer hr202CallSystem(String psAuditEmpl, String psOprId, Date psTermDate) {
		Integer status = 0;
...
//		end-if    !#Status = 0
	 ...
	 */
	public static Date hr202GetTermDate(String wrkEmplId, BigDecimal wrkIndexNum, Date psDateIn) {
		Date psTermDate;
...
//	 */
//	public static void hr202InitializeFields() {
////		LET $PSEmpl = ' '
////		LET $PSTermDate = ' '
