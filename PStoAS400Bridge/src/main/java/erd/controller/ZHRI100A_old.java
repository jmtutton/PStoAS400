...
//
public class ZHRI100A_old {
//	
////	public AdWrkFields adWrkFields;
////	public static PszTriggerEmployee trigger;
//	
...
//			getTriggerData(adLegacyOperatorId = "", adActionCode, poiFlag, isOkToProcess, completionStatus);
...
////		LET $CompletionStatus = 'P'	!Initialize the CompletionStatus field
////		Begin-Select loops=150  //get the first 150 records
////	    MOVE &PS_ZHRT_INTTRIGGER.SEQ_NBR TO #WrkSequence
////		wrkSequence = trigger.getSequenceNumber();
////	    LET $AuditOprId = LTRIM(RTRIM(&PS_ZHRT_INTTRIGGER.OPRID,' '),' ')
////		psAuditOperatorId = trigger.getOperatorId().trim();
...
//		Boolean isContractor = PsJob.ZHRI100A_checkIfContractor(trigger.getEmployeeId().trim());
////		LET $PoiFlag = 'N'
//		poiFlag = false;
